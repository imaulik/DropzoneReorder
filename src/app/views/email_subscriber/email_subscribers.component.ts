...
import { Email_subscribersService } from "../../services/index";

@Component({
    templateUrl: 'email_subscribers.component.html',
})
export class Email_subscribersComponent implements OnInit {
    ...
    constructor(private loaderService: LoaderService,
        ...
        public email_subscribersService: Email_subscribersService) {
    ...
    loadDatas(dtInstance) {
        ...
        this.email_subscribersService.getEmail_subscribers(dtInstance).subscribe(response => {
            this.dataSource = response.data;
            this.displayedColumns = ['email', 'check_broker'];
