...
import {Email_subscribersComponent} from "./email_subscribers.component";
...
const routes: Routes = [
    {
        ...
        children: [
            {
                path: '',
                component: Email_subscribersComponent,
                data: {
                    title: '',
                    permission: ['vessel.view']
                }
...
@NgModule({
    ...
    declarations: [Email_subscribersComponent]
})
export class Email_subscribersModule { }
