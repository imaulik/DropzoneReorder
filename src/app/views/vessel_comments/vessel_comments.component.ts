...
import { Vessel_commentsService } from "../../services/index";

@Component({
    templateUrl: 'vessel_comments.component.html',
})
export class Vessel_commentsComponent implements OnInit {
    ...
    loadDatas(dtInstance) {
        ...
        this.vessel_commentsService.getVessel_comments(dtInstance).subscribe(response => {
            this.dataSource = response.data;
            this.displayedColumns = ['user', 'vessel', 'option'];
