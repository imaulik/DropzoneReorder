...
import { Vessel_bidsService, LoaderService } from '../../services/index';
...
@Component({
    templateUrl: 'vessel_bids.component.html',
})
export class Vessel_bidsComponent implements OnInit {
    ...
    constructor(private loaderService: LoaderService,
        ...
        public vessel_bidsService: Vessel_bidsService) {
    ...
    loadDatas(dtInstance) {
        ...
        this.vessel_bidsService.getVessel_bids(dtInstance).subscribe(response => {
            this.dataSource = response.data;
            this.displayedColumns = ['user', 'vessel', 'bid_amount', 'created_at'];
