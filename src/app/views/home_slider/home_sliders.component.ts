...
@Component({
    templateUrl: 'home_sliders.component.html',
})
export class Home_slidersComponent implements OnInit {
    ...
    loadDatas(dtInstance) {
        ...
        this.home_slidersService.getHome_sliders(dtInstance).subscribe(response => {
    ...
    openDeleteDialog(id) {
        Swal({
            title: 'Are you sure?',
            text: 'Do you want to delete Slider Image?',
            type: 'warning',
    ...
    deleteDetail(id) {
        this.loaderService.display(true);
        this.home_slidersService.deleteHome_slider(id).subscribe(response => {
            this.loadDatas(this.dtInstance);
            this.loaderService.display(false);
        }, error => {
            this.loaderService.display(false);
