...
import { Contact_formComponent} from "./contact_form.component";
import { Contact_formViewComponent} from "./contact_form-view.component";
...
const routes: Routes = [
    {
        ...
        children: [
            {
                path: '',
                component: Contact_formComponent,
                data: {
                    title: '',
                    permission: ['vessel.view']
                }
            ...
            {
                path: 'view/:id',
                component: Contact_formViewComponent,
                data: {
                    title: 'View',
                    permission: ['vessel.edit']
                }
...
@NgModule({
    ...
    declarations: [Contact_formComponent, Contact_formViewComponent]
})
export class Contact_formModule { }
